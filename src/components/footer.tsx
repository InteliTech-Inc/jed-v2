    ...
    <footer className="relative bg-primary px-6 pt-20 lg:pt-36 text-white  overflow-hidden">
      ...
      <div className="grid text-center gap-8 md:grid-cols-2 lg:grid-cols-3 p-10 lg:place-content-center">
        <div className="flex flex-col">
          <h1 className="mx-auto md:ml-0 font-semibold text-xl w-fit">Useful Links</h1>
        ...
        <div className="flex flex-col md:items-start ">
          <h1 className="font-semibold md:text-left text-xl">Contact & Address</h1>
          <div className="flex flex-col items-center md:items-start md:text-left my-6 space-y-3 text-md">
            <a href="mailto:info.jedvotes@gmail.com" className="hover:text-accent flex items-center gap-2">
              <Icon icon={"material-symbols-light:mail-outline"} />
              info.jedvotes@gmail.com
            </a>
            <a href="tel:0599774425" className="hover:text-accent flex items-center gap-2">
              <Icon icon={"solar:phone-calling-linear"} />
              0599774425 | 0538122885
            </a>
            <a href="http://wa.me/+233264602978" className="hover:text-accent flex items-center gap-2">
      ...
      <section className="border-t-secondary/30 text-white/90 p-6 flex flex-col lg:flex-row border-t px-6 mx-auto justify-between">
        ...
        <section>
          <div className="flex justify-center py-6 gap-4">
            <a href="https://www.instagram.com/jed.event?igsh=MTVxNmk3cnJlYWxuNA==" target="_blank" rel="noopener noreferrer">
              <Icon icon={"proicons:instagram"} className="hover:text-accent size-6 transition-all duration-300 cursor-pointer hover:-translate-y-1" />
            </a>
            <Link href="https://www.linkedin.com/company/ican-code/" target="_blank" rel="noopener noreferrer">
              <Icon icon={"jam:linkedin-square"} className="hover:text-accent size-6 transition-all duration-300 cursor-pointer hover:-translate-y-1" />
            </Link>
            <a href="https://x.com/jed_event?t=rrgklc_dChJnFjdFtUAasA&s=09" target="_blank" rel="noopener noreferrer">
              <Icon icon={"proicons:x-twitter"} className="hover:text-accent size-6 transition-all duration-300 cursor-pointer hover:-translate-y-1" />
            </a>
            <a href="https://www.tiktok.com/@jed.events4?_t=ZM-8wqujOqtIzl&_r=1">
              <Icon
