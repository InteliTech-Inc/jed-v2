  ...
  return (
    <div className="mb-16">
      <section className=" p-4 text-center mt-10 max-w-screen-md mx-auto">
        ...
        <p>
          Our goal is to provide an intuitive, secure, and efficient experience for both event organizers and participants. We believe that everyone should have
          access to the tools they need to create successful events, and we're committed to making that a reality.
        </p>
      </section>
      <div className="lg:w-[90%] bg-[#f2f7e5] p-6 rounded-xl mx-auto border-2 mt-20  grid lg:grid-cols-2 gap-6 place-items-center">
        ...
        <section className="rounded-md overflow-hidden h-full">
          <Image src={AboutImage} alt="Inspire" className=" h-full object-cover object-center transition-transform ease-in duration-300 hover:scale-105 " />
        </section>
      </div>
      <section className="p-4 text-center mt-20 max-w-6xl mx-auto" id="contact">
        <h3 className="text-4xl lg:text-5xl text-neutral-800 py-4 font-semibold ">Contact Us</h3>
          ...
          {contactLines.map((line) => (
            <div key={line.value} className="border rounded-lg p-4 w-full bg-[#f2f7e5]">
              <div className="rounded-lg flex items-center justify-center bg-white text-seconary h-28">
                <Icon icon={line.icon} className=" h-12 w-12 text-secondary" />
              </div>
