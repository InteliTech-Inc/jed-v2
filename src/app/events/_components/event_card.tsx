    ...
    <div className="group transition-all duration-300">
      <Link href={`/events/${event.id}`} className="block">
        <div className="relative h-80 w-full overflow-hidden rounded-lg mb-3 transition-all duration-300">
          ...
          />
          <div className="absolute bottom-0 h-1/5 left-0 w-full p-3 bg-gradient-to-t from-black via-black/70 to-transparent">
            <p className=" group-hover:-translate-y-4 translate-y-0 transition-all duration-300 absolute bottom-2 text-white font-semibold">{event.name}</p>
