      ...
      >
        <section className="lg:p-4">
          ...
          <p className=" text-pretty">
            ...
            process saves time and ensures that nominations are collected fairly and in an organized way.
            <br />
            <br />
            We've made it possible for event creators to choose not to use our built-in nominations feature. If they prefer, they can use a third-party platform
            to manage their nominations instead. They can import the final results and use Jed to manage the voting process. This gives event organizers the
            freedom to choose the method that works best for them and makes the early stages of event planning more flexible and efficient.
          </p>
        </section>
        <section className="">
